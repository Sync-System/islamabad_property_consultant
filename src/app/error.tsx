...
export default function Error({
  ...
  return (
    <main
      id="main"
      className="flex min-h-[100svh] items-center justify-center bg-ink-950 px-gutter text-paper-50"
    >
      <div className="max-w-lg text-center">
        <p className="eyebrow text-brass-300">Something went wrong</p>
        <h1 className="mt-6 text-h2 text-paper-50">
          This page didn&rsquo;t load properly
        </h1>
        <p className="mx-auto mt-5 max-w-[42ch] text-body text-paper-100/70">
        ...
        <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
          <button type="button" onClick={reset} className={buttonClass("outlineInverse", "lg")}>
            Try again
          </button>
          <a
        ...
        {error.digest && (
          <p className="tabular mt-8 text-micro text-paper-100/35">
