 ...
 *
 * Used by the home page, the project directory and the legal pages. Project
 * pages generate their own from project data.
 */

export const size = { width: 1200, height: 630 };
export const contentType = "image/png";
export const alt = "Islamabad Property Consultant";

export default async function Image() {
  const title = "Islamabad Property Consultant";
  const location = "Property consultancy · Islamabad";
  const association = agencyConfig.positioning;
